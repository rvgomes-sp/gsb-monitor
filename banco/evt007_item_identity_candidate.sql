-- 003-S / Controle 02-R: additive candidate, not applied.
-- Prerequisite: existing canonical gsb.evt007_results. Never bootstrap a substitute.
-- Supabase CLI unavailable in execution environment: generate the versioned migration
-- with `supabase migration new evt007_catalog_bridge_v1` before applying this candidate.
DO $$
BEGIN
