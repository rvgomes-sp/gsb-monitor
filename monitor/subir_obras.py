...
def oportunidade(o: dict) -> dict:
    ...
    return {
        ...
        "porte": venc.get("porte_nome") or "", "natureza_juridica": venc.get("natureza_juridica_nome") or "",
        "objeto": (o.get("objeto") or "")[:280],
        ...
        "delta_dias": o.get("delta_calendar_days"), "frescor": o.get("freshness_class"),
        "origem": o.get("source_sender_raw"),
        "evento": "EVT-007 Homologação", "status": "NOVA", "documentos": "A confirmar edital",
...
def main() -> int:
    ...
    # dedup por numero_controle_pncp
    vistos, unicas = set(), []
    for o in ops:
